...
const SPUR_LEN = 9;             // prune dead-end skeleton branches shorter than
                                // this (px) -- the hairs that thinning leaves
const JOIN_GAP = 9;             // bridge stroke ends closer than this (px) --
                                // fewer, longer strokes = fewer gaps on the board
